...
//           <div className="relative w-12 h-16 sm:w-16 sm:h-20 bg-gradient-to-br from-blue-50 to-indigo-100 rounded-lg shadow-sm flex items-center justify-center group-hover:scale-105 transition-transform duration-300 overflow-hidden">
...
//               </>
//             ) : (
//               <div className="text-xl sm:text-2xl text-indigo-400">📚</div>
//             )}
//           </div>
//           <div className="flex-1 min-w-0">
//             <h3 className="font-bold text-lg sm:text-xl text-gray-900 truncate group-hover:text-indigo-600 transition-colors">
//               {book.title}
//             </h3>
...
//             ₹{book.price}
//           </div>
//           <div className="text-sm text-gray-600 font-medium sm:mt-1">{book.total_purchases || 0} sales</div>
//         </div>
        
//         <div className={`px-3 py-2 sm:px-4 sm:py-2 rounded-full text-xs sm:text-sm font-semibold border-2 ${getStatusColor(book.status)} shadow-sm text-center`}>
//           {book.status}
//         </div>
//       </div>
//     </div>
